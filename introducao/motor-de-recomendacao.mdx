...
## Trilhas de aprendizado e conexões entre eventos

O motor de recomendação opera em duas frentes complementares.

### Conexões explícitas

Emissores podem vincular eventos e estruturar trilhas com relações como:

| Tipo | Significado |
|------|------------|
| **Continuação** | Próximo passo direto na mesma trilha |
| **Preparatório** | Etapa que prepara para um evento posterior |
| **Aprofundamento** | Expansão de um tema já iniciado |
| **Alternativa** | Caminho diferente para um objetivo semelhante |

Quando essas conexões existem, a plataforma passa a ter um mapa mais claro da progressão esperada e consegue priorizar recomendações dentro dessa lógica.
...
Isso permite descobrir caminhos relevantes entre emissores diferentes, categorias próximas e jornadas que o participante talvez não encontrasse sozinho.
