...
| Plano | Tier API | Acesso | Rate limit |
|---|---|---|---|
| Free | — | Sem acesso à API (todas as chamadas retornam 403) | — |
| Starter | Basic | Leitura (listar eventos, badges, destinatários, saldo) | 100 req/min |
| Pro | Advanced | Leitura + escrita (emitir certificados, gerenciar eventos, webhooks) | 1.000 req/min |
| Business | Advanced | Mesmo que Pro, com rate limit igual | 1.000 req/min |
| Enterprise | Advanced | Mesmo que Pro, com rate limit elevado | 10.000 req/min (ajustável sob negociação) |
