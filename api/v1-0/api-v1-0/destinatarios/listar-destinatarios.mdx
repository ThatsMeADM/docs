...
<ParamField query="invitation_id" type="string">
...
<ParamField query="recipient_phone" type="string">
  Telefone informado no momento da emissão. (UIT E.164)
  Ex: +5531987654321
</ParamField>
...
```json Response (400)
{
  ...
  "message": "Informe event_id ou badge_id e pelo menos um dos seguintes: recipient_email, recipient_phone ou invitation_id."
}
```
